...
{
    public partial class AllGroupsForm : Form
    {
        private List<Student> studentsGroup1;
        private List<Student> studentsGroup2;
        private List<Student> studentsGroup3;

        public AllGroupsForm(List<Student> students1, List<Student> students2, List<Student> students3)
        {
        ...
        private void PrintAllStudents()
        {
            ...
            // Сортировка
            var sortedStudents = allGroups.OrderBy(student => student.Name); 
            ...
            /* Сериализация */
            Helper.Serialize(sortedStudents.ToList(), @"..\..\Database\AllGroups(alphabetical_order).bin");
        }
    }
}